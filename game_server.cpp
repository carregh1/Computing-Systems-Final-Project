...
void *threadGame(void *args)
{
    ...
    string line;
    string fileName;
    // Open file containing game words
    fileName = "cpsc3500/projects/p4/words.txt";
    ifstream infile;
	...
	// Sending wordLength and wordPlay
	...
	wordPlay = guessed[0]; // Copy changes
		...
		if (same == wordLength){
		    result = 100;
		    finished = true;
		} else // If the guess wasn't alphabetical, make the user re-enter guess
		    result = -2;
		// Send result 
	...
	// Game is finished. Send finish msg, calc score
